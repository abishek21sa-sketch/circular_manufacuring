...
Write-Host "Circular Manufacturing Phase 10 Final Portable-AI Acceptance"
...
Invoke-PythonChecked @("-m","pytest","-q",
    "tests/test_phase10_release_gate.py",
    "tests/test_phase10_decision_intelligence.py")
Write-Host "PHASE 10 HOTFIX ACCEPTANCE PASSED"
